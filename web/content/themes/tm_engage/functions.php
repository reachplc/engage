...
function tm_engage_scripts() {
	...
	wp_enqueue_script( 'tm_engage-classie', get_template_directory_uri() . '/js/classie.js', array( 'jquery' ), '20150519', true );
	wp_enqueue_script( 'tm_engage-stepsform', get_template_directory_uri() . '/js/stepsForm.js', array( 'jquery' ), '1.0.0', true );
	wp_enqueue_script( 'tm_engage-bootstrap', get_template_directory_uri() . '/js/bootstrap.min.js', array( 'jquery' ), '3.1.1', true );
	wp_enqueue_script( 'tm_engage-flexslider', get_template_directory_uri() . '/js/flexslider.min.js', array( 'jquery' ), '20150519', true );
	wp_enqueue_script( 'tm_engage-parallax', get_template_directory_uri() . '/js/parallax.min.js', array( 'jquery' ), '20150519', true );
