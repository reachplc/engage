...
<?php foreach ( $recent_news as $post ) : setup_postdata( $post );?>
			<div class="col-sm-4 col-md-4 wp5 delay-05s">
			  <div class="overlay-effect effects clearfix">
	                ...
	                <?php else : ?>
	                  <img src="<?php echo esc_html( get_template_directory_uri() . '/gui/feature-placeholder.png' ); ?>" alt="">
	                <?php endif; ?>
				  <div class="overlay">
			  ...
			  <h2><a href="<?php echo esc_url( get_permalink( $post->ID ) ) ?>"><?php echo get_the_title( $post->ID ); ?></a></h2>
				<?php the_excerpt(); ?>
			</div>
<?php endforeach;
wp_reset_postdata(); ?>
	...
	<div class="row">
	  <div class="col-md-10 col-md-offset-1">
		...
		<a class="btn btn--primary btn-lg" href="<?php echo esc_url( get_permalink( get_page_by_path( 'news' ) ) ); ?>">Blog Archive</a>
