 ...
 *
 * @uses tm_engage_header_style()
 * @uses tm_engage_admin_header_style()
 * @uses tm_engage_admin_header_image()
 */
function tm_engage_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'tm_engage_custom_header_args', array(
		'default-image'          => '',
		'default-text-color'     => '000000',
		'width'                  => 1000,
		'height'                 => 250,
		'flex-height'            => true,
		'wp-head-callback'       => 'tm_engage_header_style',
		'admin-head-callback'    => 'tm_engage_admin_header_style',
		'admin-preview-callback' => 'tm_engage_admin_header_image',
	) ) );
}
